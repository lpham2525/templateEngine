...
* Below is an example of what the application may look like. Style it to be unique.
...
It is recommended to follow this workflow:
...
It is recommended that to start with a directory structure that looks like this:
...
* Create multiple HTML templates for each type of user with the following templates:
...
* Make methods simple so that they are easier to test.

* The different employee types should all inherit some methods and properties from a base class of `Employee`.

* In HTML template files, add a placeholder character that helps the program identify where the dynamic markup begins and ends.
